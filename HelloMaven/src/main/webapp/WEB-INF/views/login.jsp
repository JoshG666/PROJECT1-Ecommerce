...
<div class="login_sec">
	 <div class="container">
		 ...
		 <div class="col-md-6 log">			 
				 ...
				 <p>If you have previously Login with us, enter your credentials</p>
				 <form name="login" 
				action="<c:url value='/j_spring_security_check' />" method="post" >
				 <div class="error" style="color: #ff0000;">${usernameError}${emailError}${userPhoneError }${error}</div>
...
<div class="copywrite">
	 <div class="container">
		 ...
		 <div class="social">							
				...
				<a href="http://w3layouts.com/"><i class="dribble"></i></a>	
