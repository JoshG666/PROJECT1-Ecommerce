...
<li>
<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span><a href="<c:url value="/user/cart"/>">Cart</a></li>
...
<li><a href="<c:url value="/loginpage"/>">Login</a></li>
			 ...
			 <div class="top-nav">
				<ul class="memenu skyblue"><li class="active"><a href="<c:url value="/resources/web/index.html"/>">Home</a></li>
					<li class="grid"><a href="/index">Products</a>
						<%-- <div class="mepanel">
							<div class="row">
			 ...
			 <!-- <div class="cart box_1">
				...
				<p><a href="/user/cart" class="simpleCart_empty"> Cart</a></p>
