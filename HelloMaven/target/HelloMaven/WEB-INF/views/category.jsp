			...
			<section>
					...
					<form:form action="${addAction}" commandName="category" method="post">
								...
								<c:when test="${!empty category.category_id}">
									...
									<div class="form-group">
										...
										<div class="controls docs-input-sizes">
											<form:input placeholder="id" path="category_id" required="true"
												class="form-control" id="category_id" disabled="true" readonly="true" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="controls docs-input-sizes">
											<form:input placeholder="id" path="category_id" required="true"
												...
												title="category_id should contains 6 to 7 characters"
												patttern=".{6,7}" />
										</div>
									</div>
						...
						<div class="form-group">
							...
							<div class="controls docs-input-sizes">
								<form:input placeholder="name" path="category_name" required="true"
						...
						<div class="form-group">
							...
							<div class="controls docs-input-sizes">
								<form:input placeholder="description" path="category_description"
						...
						<div class="form-group">
							<div class="controls docs-input-sizes">
								...
								<c:if test="${empty category.category_name}">
									...
									<input  type="submit" value="Add category"/><!-- class="btn btn-template-main pull-left">
